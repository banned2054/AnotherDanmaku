...
public static class InputHelp
{
    public static List<Binding> GetDefaults()
    {
        ...
        Add(b, new Binding(_("File"), _("Open Files..."), "script-message-to mpvnet open-files", "o"));
        Add(b,
            new Binding(_("File"), _("Open URL or file from clipboard"), "script-message-to mpvnet open-clipboard",
                        "Ctrl+v"));
        Add(b,
            new Binding(_("File"), _("Open DVD/Blu-ray Drive/Folder..."),
                        "script-message-to mpvnet open-optical-media"));
        Add(b, new Binding(_("File"), "-"));
        Add(b, new Binding(_("File"), _("Add external audio files..."), "script-message-to mpvnet load-audio", "Alt+a"));
        Add(b, new Binding(_("File"), _("Add external subtitle files..."), "script-message-to mpvnet load-sub", "Alt+s"));
        Add(b, new Binding(_("File"), "-"));
        Add(b, new Binding(_("File"), _("Add files to playlist..."), "script-message-to mpvnet open-files append"));
        Add(b,
            new Binding(_("File"), _("Add files/URLs to playlist from clipboard"),
                        "script-message-to mpvnet open-clipboard append", "Ctrl+Shift+v"));
        Add(b, new(_("File"), "-"));
        ...
        Add(b, new(_("Subtitle"), "-"));
        Add(b,
            new(_("Subtitle") + " > " + _("More"), _("Toggle overriding SSA/ASS styles with normal styles"),
                "cycle-values sub-ass-override force no", "u"));
        ...
        Add(b,
            new(_("View"), _("Show Media Info Message Box"), "script-message-to mpvnet show-media-info msgbox",
                "Ctrl+m"));
        ...
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Properties"), "script-binding select/show-properties",
                "F3"));
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Chapters"), "script-binding select/select-chapter",
                "Alt+c"));
        ...
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Secondary Subtitle"),
                "script-binding select/select-secondary-sid", "Alt+b"));
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Video Tracks"), "script-binding select/select-vid",
                "Alt+v"));
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Subtitle Lines"),
                "script-binding select/select-subtitle-line", "Alt+l"));
        Add(b,
            new(_("View") + " > " + _("On Screen Menu"), _("Audio Devices"),
                "script-binding select/select-audio-device", "Alt+d"));

        if (File.Exists(Player.ConfigFolder + "/scripts/command_palette.lua"))
        {
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Command Palette"),
                    "script-message-to command_palette show-command-palette \"Command Palette\"", "Ctrl+p"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Bindings"),
                    "script-message-to command_palette show-command-palette \"Bindings\"", "F1"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Properties"),
                    "script-message-to command_palette show-command-palette \"Properties\"", "F2"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Commands"),
                    "script-message-to command_palette show-command-palette \"Commands\"", "F3"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Options"),
                    "script-message-to command_palette show-command-palette \"Options\"", "F4"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Playlist"),
                    "script-message-to command_palette show-command-palette \"Playlist\"", "F8"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Tracks"),
                    "script-message-to command_palette show-command-palette \"Tracks\"", "F9"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Audio Tracks"),
                    "script-message-to command_palette show-command-palette \"Audio Tracks\"", "Alt+a"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Subtitle Tracks"),
                    "script-message-to command_palette show-command-palette \"Subtitle Tracks\"", "Alt+s"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Secondary Subtitle"),
                    "script-message-to command_palette show-command-palette \"Secondary Subtitle\"", "Alt+b"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Video Tracks"),
                    "script-message-to command_palette show-command-palette \"Video Tracks\"", "Alt+v"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Chapters"),
                    "script-message-to command_palette show-command-palette \"Chapters\"", "Alt+c"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Profiles"),
                    "script-message-to command_palette show-command-palette \"Profiles\"", "Alt+p"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Audio Devices"),
                    "script-message-to command_palette show-command-palette \"Audio Devices\"", "Alt+d"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Subtitle Line"),
                    "script-message-to command_palette show-command-palette \"Subtitle Line\"", "Alt+l"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Blu-ray Titles"),
                    "script-message-to command_palette show-command-palette \"Blu-ray Titles\"", "Alt+t"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Stream Quality"),
                    "script-message-to command_palette show-command-palette \"Stream Quality\"", "Alt+q"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Aspect Ratio"),
                    "script-message-to command_palette show-command-palette \"Aspect Ratio\"", "Alt+r"));
            Add(b,
                new(_("View") + " > " + _("Command Palette"), _("Recent Files"),
                    "script-message-to mpvnet show-recent-in-command-palette", "Alt+f"));
        }
        ...
        Add(b,
            new(_("View") + " > " + _("More"), _("Show Protocols"), "script-message-to mpvnet show-protocols",
                "Alt+p"));
        ...
        Add(b,
            new(_("Window") + " > " + _("Move"), _p("Move", "Left"), "script-message-to mpvnet move-window left",
                "Alt+Left"));
        Add(b,
            new(_("Window") + " > " + _("Move"), _p("Move", "Right"), "script-message-to mpvnet move-window right",
                "Alt+Right"));
        Add(b,
            new(_("Window") + " > " + _("Move"), _p("Move", "Up"), "script-message-to mpvnet move-window top",
                "Alt+Up"));
        Add(b,
            new(_("Window") + " > " + _("Move"), _p("Move", "Down"), "script-message-to mpvnet move-window bottom",
                "Alt+Down"));
        Add(b,
            new(_("Window") + " > " + _("Move"), _p("Move", "Center"), "script-message-to mpvnet move-window center",
                "Alt+BS"));
        ...
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Register video file associations"),
                "script-message-to mpvnet reg-file-assoc video"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Register audio file associations"),
                "script-message-to mpvnet reg-file-assoc audio"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Register image file associations"),
                "script-message-to mpvnet reg-file-assoc image"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Unregister file associations"),
                "script-message-to mpvnet reg-file-assoc unreg"));
        Add(b, new(_("Settings") + " > " + _("Setup"), "-"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Add mpv.net to Path environment variable"),
                "script-message-to mpvnet add-to-path"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Remove mpv.net from Path environment variable"),
                "script-message-to mpvnet remove-from-path"));
        Add(b, new(_("Settings") + " > " + _("Setup"), "-"));
        Add(b,
            new(_("Settings") + " > " + _("Setup"), _("Install Command Palette"),
                "script-message-to mpvnet install-command-palette"));
        ...
        Add(b,
            new(_("Help"), _("Website mpv.net"),
                "script-message-to mpvnet shell-execute https://github.com/mpvnet-player/mpv.net"));
        Add(b, new(_("Help"), "-"));
        Add(b,
            new(_("Help"), _("Manual mpv"), "script-message-to mpvnet shell-execute https://mpv.io/manual/stable",
                "Ctrl+F1"));
        Add(b,
            new(_("Help"), _("Manual mpv.net"),
                "script-message-to mpvnet shell-execute https://github.com/mpvnet-player/mpv.net/blob/main/docs/manual.md",
                "Ctrl+F2"));
        Add(b, new(_("Help"), "-"));
        Add(b,
            new(_("Help"), _("awesome-mpv"),
                "script-message-to mpvnet shell-execute https://github.com/stax76/awesome-mpv", "Ctrl+a"));
        ...
        static void Add(ICollection<Binding> bindings, Binding b) => bindings.Add(b);
    }
    ...
    public static string ConvertToString(List<Binding> bindings)
    {
        ...
        foreach (var binding in bindings)
        {
            ...
            if (binding.Comment != "" &&
                binding is { Command: "", Input: "", IsMenu: false })
            {
                sb.AppendLine("#" + binding.Comment.Trim());
                continue;
            }

            var command = binding.Command.Trim();
            var input   = binding.Input.Trim();
            input = input == "" ? "_" : input;
            var line = input.PadRight(10) + "  ";
    ...
    public static List<Binding> Parse(string content)
    {
        ...
        foreach (var it in content.Split('\n'))
        {
            var line = it.Trim();
            ...
            binding.Input = line[..line.IndexOf(" ", StringComparison.Ordinal)];
            ...
            {
                binding.Comment =
                    line[(line.IndexOf(App.MenuSyntax, StringComparison.Ordinal) + App.MenuSyntax.Length)..].Trim();
                binding.IsMenu = true;
                line           = line[..line.IndexOf(App.MenuSyntax, StringComparison.Ordinal)];
            }
            else if (line.Contains("#custom-menu:"))
            {
                binding.Comment      = line[(line.IndexOf("#custom-menu:", StringComparison.Ordinal) + 13)..].Trim();
                binding.IsCustomMenu = true;
                line                 = line[..line.IndexOf("#custom-menu:", StringComparison.Ordinal)];
            }
            else if (line.Contains('#'))
            {
                binding.Comment = line[(line.IndexOf("#", StringComparison.Ordinal) + 1)..].Trim();
                if (line.IndexOf("#", StringComparison.Ordinal) >= 0 &&
                    line.IndexOf("#", StringComparison.Ordinal) <= line.Length)
    ...
    public static List<Binding> GetReducedBindings(List<Binding> bindings)
    {
        ...
        var removedBindings = (from defaultBinding in defaultBindings
                               from binding in bindings
                               where defaultBinding.Input   == binding.Input   &&
    ...
    public static Dictionary<string, Binding> GetActiveBindings(List<Binding> bindings)
    {
        ...
        foreach (var binding in bindings.Where(binding => binding.Input != "" && binding.Command != ""))
        {
    ...
    public static string GetBindingsForCommand(Dictionary<string, Binding> activeBindings, string command)
    {
        ...
        foreach (var binding in from it in activeBindings
                                where it.Value.Command == command
                                select it.Value
                                into binding
                                where !keys.Contains(binding.Input) && (charCount + binding.Input.Length) < 15
                                select binding)
        {
