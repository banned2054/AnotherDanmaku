...
public class MainPlayer : MpvClient
{
    ...
    protected override void OnLogMessage(MpvEventLogMessage data)
    {
        if (data.log_level == MpvLogLevel.MpvLogLevelInfo)
        {
    ...
    protected override void OnEndFile(MpvEventEndFile data)
    {
        base.OnEndFile(data);
        FileEnded = true;
    }
    ...
    public MainPlayer(Dictionary<string, string>? conf)
    {
        _conf = conf;
    }
