...
public sealed partial class MessageBoxEx : Window, INotifyPropertyChanged
{
    ...
    public MessageBoxButton? Buttons
    {
        ...
        set
        {
            ...
            _buttons = value;
            NotifyPropertyChanged();
            NotifyPropertyChanged(nameof(ShowOk));
            NotifyPropertyChanged(nameof(ShowCancel));
            NotifyPropertyChanged(nameof(ShowYes));
            NotifyPropertyChanged(nameof(ShowNo));
        }
    }
    ...
    public MessageBoxButtonEx? ButtonsEx
    {
        ...
        set
        {
            ...
            NotifyPropertyChanged(nameof(ShowYes));
            NotifyPropertyChanged(nameof(ShowNo));
            NotifyPropertyChanged(nameof(ShowAbort));
            NotifyPropertyChanged(nameof(ShowRetry));
            NotifyPropertyChanged(nameof(ShowIgnore));
        }
    }

    public Visibility ShowOk => (!_usingExButtons && Buttons   == MessageBoxButton.OK       ||
                                 !_usingExButtons && Buttons   == MessageBoxButton.OKCancel ||
                                 _usingExButtons  && ButtonsEx == MessageBoxButtonEx.OK     ||
                                 _usingExButtons  && ButtonsEx == MessageBoxButtonEx.OKCancel)
        ? Visibility.Visible
        : Visibility.Collapsed;

    public Visibility ShowCancel => (!_usingExButtons && Buttons   == MessageBoxButton.OKCancel      ||
                                     !_usingExButtons && Buttons   == MessageBoxButton.YesNoCancel   ||
                                     _usingExButtons  && ButtonsEx == MessageBoxButtonEx.OKCancel    ||
                                     _usingExButtons  && ButtonsEx == MessageBoxButtonEx.YesNoCancel ||
                                     _usingExButtons  && ButtonsEx == MessageBoxButtonEx.RetryCancel)
        ? Visibility.Visible
        : Visibility.Collapsed;

    public Visibility ShowYes => (!_usingExButtons && Buttons   == MessageBoxButton.YesNo       ||
                                  !_usingExButtons && Buttons   == MessageBoxButton.YesNoCancel ||
                                  _usingExButtons  && ButtonsEx == MessageBoxButtonEx.YesNo     ||
                                  _usingExButtons  && ButtonsEx == MessageBoxButtonEx.YesNoCancel)
        ? Visibility.Visible
        : Visibility.Collapsed;

    public Visibility ShowNo => (!_usingExButtons && Buttons   == MessageBoxButton.YesNo       ||
                                 !_usingExButtons && Buttons   == MessageBoxButton.YesNoCancel ||
                                 _usingExButtons  && ButtonsEx == MessageBoxButtonEx.YesNo     ||
                                 _usingExButtons  && ButtonsEx == MessageBoxButtonEx.YesNoCancel)
        ? Visibility.Visible
    ...
    public Visibility ShowRetry => (_usingExButtons && ButtonsEx == MessageBoxButtonEx.AbortRetryIgnore ||
                                    _usingExButtons && ButtonsEx == MessageBoxButtonEx.RetryCancel)
        ? Visibility.Visible
        : Visibility.Collapsed;

    public Visibility ShowAbort => (_usingExButtons && ButtonsEx == MessageBoxButtonEx.AbortRetryIgnore)
        ? Visibility.Visible
        : Visibility.Collapsed;

    public Visibility ShowIgnore => (_usingExButtons && ButtonsEx == MessageBoxButtonEx.AbortRetryIgnore)
        ? Visibility.Visible
        : Visibility.Collapsed;
    ...
    public double ButtonWidth
    {
        ...
        set
        {
            if (Math.Abs(value - _buttonWidth) < 0.000001) return;
            _buttonWidth = value;
            NotifyPropertyChanged();
        }
    }
